...
//  Animation
//
//  Created by Qing's on 2017/11/24.
...
open class CRNetworkButton: UIButton {
    ...
    @IBInspectable open var startText:String = "检查" {
        didSet {
            updateText()
        }
    }
    @IBInspectable open var endText:String = "可用" {
        didSet {
            updateText()
        }
    }
    
    @IBInspectable open var errorText:String = "错误"
